...
- Simply open the file that sounds more interesting, click the "Raw" button, then type in Javascript:, then copy the code and paste it into the chrome console when you're on prodigy.
